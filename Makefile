...
# translation
SOURCES = responseratio.py ui_responseratio.py __init__.py responseratiodialog.py
#TRANSLATIONS = i18n/responseratio_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = responseratio

PY_FILES = responseratio.py responseratiodialog.py __init__.py

EXTRAS = icon.png metadata.txt

UI_FILES = ui_responseratio.py
